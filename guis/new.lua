	...
	PatchNotes = {
		{
			Version = '4.27',
			Date = 'July 2026',
			Highlight = 'Killaura Legit mode, a Universal Player Attach module, and BedWars fixes.',
			...
			Changes = {
				'[BedWars][feature] Anti Crash (Whisper) and Anti Crash (Eldric): immunity to two new kit-ability crash exploits',
				'[BedWars][feature] New Auto Jack module: instantly full-charges the Oil Spitter (or speeds the charge up) for max-size oil blobs',
				'[BedWars][feature] Auto Jack: Torch Aimbot silently aims your thrown Fire Match at an oil blob (Nearest/Farthest/Biggest/Smallest/Cursor)',
				'[BedWars][fix] Auto Jack and the rest of the match modules now load in every BedWars mode, not only custom matches',
				'[BedWars][fix] Auto Jack: the charge bar now fills at the Instant Charge / Charge Speed rate, matching the boosted throw',
				'[BedWars][feature] Auto Jack: Infinite Oil keeps your oil topped up so you can aim and throw full-size blobs even at empty, using the normal throw',
				'[BedWars][feature] Auto Jack: Throw Cooldown slider (0.01-1s) caps how fast you can re-throw oil, dropping throws that come too soon',
				'[BedWars][feature] Auto Jack: Auto Ignite auto-lobs a Fire Match at your unlit oil blobs so they light themselves (needs Fire Match ammo)',
				'[BedWars][feature] Killaura: Legit toggle + Hit Chance slider (aura sends only that % of swings, you land the rest)',
				'[BedWars][feature] Auto Davey: Limit to Item toggle -- only breaks the cannon while a pickaxe is held',
				'[Universal][feature] New Player Attach module: attaches to the nearest target player',
				'[BedWars][fix] Kit ESP: no longer shows Beekeeper tamed hive bees',
				'[Universal][fix] Target/friend "in the server" notifications now fire reliably',
				'[BedWars][fix] Removed Anti Crash (Wren) and Anti Crash (Block Kick)',
			},
		},
		{
			Version = '4.26',
